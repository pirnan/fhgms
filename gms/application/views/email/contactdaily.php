    ...
    <body>
        ...
        <div class="main">
            ...
            <form class="form1" method="post" action="<?php echo base_url('index.php/EmailController/send')?>" enctype="multipart/form-data">
                ...
                <br><br>
                <input type="text" name="typeofmembership" style="background-color:lightgray;" Value="Daily" >
                <br><br>
                <input type="text" name="priceofmembership" style="background-color:lightgray;" Value="PHP 80">
                <br><br>               
