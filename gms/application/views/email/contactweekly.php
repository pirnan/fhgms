    ...
    <body>
        ...
        <div class="main">
            ...
            <form class="form1" method="post" action="<?php echo base_url('index.php/EmailController/send')?>" enctype="multipart/form-data">
                ...
                <br><br>
                <input type="text" style="background-color:lightgray;" name="typeofmembership" Value="Weekly" disabled>
                <br><br>
                <input type="text" style="background-color:lightgray;" name="priceofmembership" Value="PHP 240" disabled>
                <br><br>               
